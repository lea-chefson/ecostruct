...
const employees2 = [
 
  {
    name: "Sital Gill",
    description:
      "Sital, a talented and driven individual, hails from Australia and is a permanent resident of Singapore. Born into a family with strong ties to the financial sector, her mother serves as the Assistant Chief Executive of the Accounting and Corporate Regulatory Authority (ACRA) in Singapore. This influential background inspired Sital to pursue her passion for finance and law.\n\nSital obtained a Bachelor's degree in Finance and a Bachelor of Laws (LLB) from the renowned Monash University in Australia, equipping her with a solid foundation in both disciplines. Since the commencement of her professional journey, she has continually broadened her skill set, which aids her in her diverse career interests.\n\nSital is best known for her roles as an investor, entrepreneur, and business owner. Her keen eye for opportunities and expert knowledge of the financial and legal domains has enabled her to consistently make strategic investments and establish successful businesses.\n\nIn 2015, Sital took a monumental step in her career when she was appointed Chief Executive of Powella, a prominent Singaporean company. Since her appointment, she has successfully steered the organisation towards growth and expansion while remaining vigilant about economic and market conditions.\n\nThroughout her career, Sital's commitment to excellence and unwavering determination has served as an inspiration to many aspiring professionals. As she continues to make her mark in the business world, there is little doubt that her influence and legacy will leave a lasting impact.",
    contact: "david.lee@example.com",
    image: sital,
  },
  {
